...
#
# API budget: ~150 models × 6 calls = ~900 calls per cold prewarm.
# With skip-if-cached (70% warm threshold), daily refresh cost is
# typically ~200-300 calls, leaving ~4,700/day for scanning.
# ==========================================
PREWARM_TARGETS = [
    ...
    ("Ford", "Kuga",       [2013, 2014, 2015, 2016, 2017, 2018, 2019],       [30000, 50000, 70000, 90000, 110000]),
    ("Ford", "Mondeo",     [2013, 2014, 2015, 2016, 2017, 2018],             [30000, 50000, 70000, 90000, 110000]),
    ("Ford", "EcoSport",   [2014, 2015, 2016, 2017, 2018, 2019],             [20000, 40000, 60000, 80000]),
    ("Ford", "Puma",       [2019, 2020, 2021, 2022],                         [10000, 20000, 30000, 50000]),
    ("Ford", "S-Max",      [2013, 2014, 2015, 2016, 2017, 2018],             [40000, 60000, 80000, 100000, 120000]),
    ("Ford", "Galaxy",     [2013, 2014, 2015, 2016, 2017, 2018],             [40000, 60000, 80000, 100000, 120000]),
    ("Ford", "Ranger",     [2013, 2014, 2015, 2016, 2017, 2018, 2019],       [40000, 60000, 80000, 100000, 120000]),
    ("Ford", "Transit",    [2014, 2015, 2016, 2017, 2018, 2019],             [60000, 80000, 100000, 120000, 150000]),

    # ── VAUXHALL ──────────────────────────────────────────────────────────
    ("Vauxhall", "Corsa",     [2013, 2014, 2015, 2016, 2017, 2018, 2019],    [20000, 40000, 60000, 80000, 100000, 120000]),
    ("Vauxhall", "Astra",     [2013, 2014, 2015, 2016, 2017, 2018],          [30000, 50000, 70000, 90000, 110000]),
    ("Vauxhall", "Insignia",  [2013, 2014, 2015, 2016, 2017, 2018],          [40000, 60000, 80000, 100000, 120000]),
    ("Vauxhall", "Mokka",     [2013, 2014, 2015, 2016, 2017, 2018],          [30000, 50000, 70000, 90000]),
    ("Vauxhall", "Zafira",    [2012, 2013, 2014, 2015, 2016, 2017],          [40000, 60000, 80000, 100000]),
    ("Vauxhall", "Meriva",    [2012, 2013, 2014, 2015, 2016],                [30000, 50000, 70000, 90000]),
    ...
    ("Vauxhall", "Vivaro",    [2014, 2015, 2016, 2017, 2018, 2019],          [60000, 80000, 100000, 130000]),
    ...
    ("Volkswagen", "Touran",  [2015, 2016, 2017, 2018, 2019],                [30000, 50000, 70000, 90000]),
    ("Volkswagen", "T-Roc",   [2018, 2019, 2020, 2021],                      [10000, 20000, 40000, 60000]),
    ...
    ("Audi", "A4", [2013, 2014, 2015, 2016, 2017, 2018],                     [30000, 50000, 70000, 90000, 110000]),
    ("Audi", "A5", [2013, 2014, 2015, 2016, 2017, 2018],                     [30000, 50000, 70000, 90000]),
    ("Audi", "A6", [2013, 2014, 2015, 2016, 2017, 2018],                     [40000, 60000, 80000, 100000, 120000]),
    ("Audi", "Q2", [2016, 2017, 2018, 2019, 2020],                           [10000, 20000, 40000, 60000]),
    ("Audi", "Q3", [2013, 2014, 2015, 2016, 2017, 2018],                     [20000, 40000, 60000, 80000]),
    ("Audi", "Q5", [2013, 2014, 2015, 2016, 2017, 2018],                     [30000, 50000, 70000, 90000]),
    ...
    ("Bmw", "3 Series", [2012, 2013, 2014, 2015, 2016, 2017, 2018],          [30000, 50000, 70000, 90000, 110000]),
    ...
    ("Bmw", "X3",       [2013, 2014, 2015, 2016, 2017, 2018],                [30000, 50000, 70000, 90000]),
    ...
    ("Mercedes-Benz", "C-Class",  [2013, 2014, 2015, 2016, 2017, 2018],      [30000, 50000, 70000, 90000]),
    ("Mercedes-Benz", "E-Class",  [2013, 2014, 2015, 2016, 2017, 2018],      [40000, 60000, 80000, 100000]),
    ...
    ("Mercedes-Benz", "Gle",      [2015, 2016, 2017, 2018],                  [30000, 50000, 70000, 90000]),
    ("Mercedes-Benz", "Cla",      [2013, 2014, 2015, 2016, 2017, 2018],      [20000, 40000, 60000, 80000]),
    ("Mercedes-Benz", "Sprinter", [2014, 2015, 2016, 2017, 2018],            [60000, 80000, 100000, 130000]),
    ("Mercedes-Benz", "Vito",     [2014, 2015, 2016, 2017, 2018],            [60000, 80000, 100000, 130000]),
    ...
    ("Toyota", "Corolla", [2015, 2016, 2017, 2018, 2019, 2020],              [10000, 20000, 40000, 60000, 80000]),
    ("Toyota", "Aygo",    [2014, 2015, 2016, 2017, 2018, 2019],              [10000, 20000, 40000, 60000]),
    ("Toyota", "C-HR",    [2016, 2017, 2018, 2019, 2020],                    [10000, 20000, 40000, 60000]),
    ("Toyota", "RAV4",    [2013, 2014, 2015, 2016, 2017, 2018],              [30000, 50000, 70000, 90000]),
    ...
    ("Nissan", "Leaf",    [2015, 2016, 2017, 2018, 2019],                    [10000, 20000, 40000, 60000]),
    ("Nissan", "X-Trail", [2014, 2015, 2016, 2017, 2018],                    [30000, 50000, 70000, 90000]),
    ...
    ("Honda", "CR-V",  [2013, 2014, 2015, 2016, 2017, 2018],                 [30000, 50000, 70000, 90000]),
    ("Honda", "HR-V",  [2015, 2016, 2017, 2018, 2019],                       [20000, 40000, 60000, 80000]),

    # ── HYUNDAI ───────────────────────────────────────────────────────────
    ("Hyundai", "I10",    [2013, 2014, 2015, 2016, 2017, 2018],              [10000, 20000, 40000, 60000]),
    ...
    ("Hyundai", "Ix35",   [2012, 2013, 2014, 2015, 2016],                    [30000, 50000, 70000, 90000]),

    # ── KIA ───────────────────────────────────────────────────────────────
    ("Kia", "Picanto",  [2013, 2014, 2015, 2016, 2017, 2018],                [10000, 20000, 40000, 60000]),
    ...
    ("Kia", "Niro",     [2016, 2017, 2018, 2019, 2020],                      [10000, 20000, 40000, 60000]),
    ("Kia", "Sorento",  [2013, 2014, 2015, 2016, 2017, 2018],                [30000, 50000, 70000, 90000]),
    ...
    ("Seat", "Arona", [2017, 2018, 2019, 2020],                              [10000, 20000, 40000, 60000]),
    ...
    ("Skoda", "Superb",  [2014, 2015, 2016, 2017, 2018],                     [30000, 50000, 70000, 90000]),
    ("Skoda", "Karoq",   [2017, 2018, 2019, 2020],                           [10000, 20000, 40000, 60000]),
    ("Skoda", "Kodiaq",  [2017, 2018, 2019, 2020],                           [20000, 40000, 60000, 80000]),
    ("Skoda", "Yeti",    [2012, 2013, 2014, 2015, 2016, 2017],               [30000, 50000, 70000, 90000]),

    # ── PEUGEOT ───────────────────────────────────────────────────────────
    ("Peugeot", "108",     [2014, 2015, 2016, 2017, 2018],                   [10000, 20000, 40000, 60000]),
    ...
    ("Peugeot", "3008",    [2013, 2014, 2015, 2016, 2017, 2018],             [30000, 50000, 70000, 90000]),
    ("Peugeot", "5008",    [2014, 2015, 2016, 2017, 2018],                   [30000, 50000, 70000, 90000]),
    ("Peugeot", "2008",    [2014, 2015, 2016, 2017, 2018],                   [20000, 40000, 60000, 80000]),
    ("Peugeot", "Partner", [2013, 2014, 2015, 2016, 2017, 2018],             [50000, 70000, 90000, 110000]),
    ...
    ("Renault", "Zoe",    [2014, 2015, 2016, 2017, 2018, 2019],              [10000, 20000, 40000, 60000]),
    ("Renault", "Kangoo", [2013, 2014, 2015, 2016, 2017],                    [40000, 60000, 80000, 100000]),

    # ── CITROEN ───────────────────────────────────────────────────────────
    ("Citroen", "C1",       [2013, 2014, 2015, 2016, 2017, 2018],            [10000, 20000, 40000, 60000]),
    ("Citroen", "C3",       [2013, 2014, 2015, 2016, 2017, 2018],            [20000, 40000, 60000, 80000]),
    ("Citroen", "C4",       [2013, 2014, 2015, 2016, 2017],                  [30000, 50000, 70000, 90000]),
    ...
    ("Citroen", "Dispatch", [2014, 2015, 2016, 2017, 2018],                  [50000, 70000, 90000, 110000]),

    # ── FIAT ──────────────────────────────────────────────────────────────
    ("Fiat", "500",   [2012, 2013, 2014, 2015, 2016, 2017, 2018],            [20000, 40000, 60000, 80000]),
    ("Fiat", "Punto", [2012, 2013, 2014, 2015, 2016],                        [30000, 50000, 70000, 90000]),
    ...
    ("Mazda", "Mazda6", [2013, 2014, 2015, 2016, 2017, 2018],                [30000, 50000, 70000, 90000]),
    ("Mazda", "CX-3",   [2015, 2016, 2017, 2018, 2019],                      [20000, 40000, 60000, 80000]),
    ("Mazda", "CX-5",   [2013, 2014, 2015, 2016, 2017, 2018],                [30000, 50000, 70000, 90000]),

    # ── VOLVO ─────────────────────────────────────────────────────────────
    ("Volvo", "V40",  [2013, 2014, 2015, 2016, 2017, 2018],                  [20000, 40000, 60000, 80000, 100000]),
    ("Volvo", "V60",  [2013, 2014, 2015, 2016, 2017, 2018],                  [30000, 50000, 70000, 90000]),
    ("Volvo", "XC40", [2017, 2018, 2019, 2020],                              [10000, 20000, 40000, 60000]),
    ("Volvo", "XC60", [2013, 2014, 2015, 2016, 2017, 2018],                  [30000, 50000, 70000, 90000]),
    ("Volvo", "XC90", [2015, 2016, 2017, 2018],                              [30000, 50000, 70000, 90000]),
    ...
    ("Land Rover", "Defender",            [2018, 2019, 2020, 2021],              [10000, 20000, 40000, 60000]),

    # ── JAGUAR ────────────────────────────────────────────────────────────
    ("Jaguar", "XE",     [2015, 2016, 2017, 2018, 2019],                     [20000, 40000, 60000, 80000]),
    ("Jaguar", "XF",     [2013, 2014, 2015, 2016, 2017, 2018],               [30000, 50000, 70000, 90000]),
    ("Jaguar", "F-Pace", [2016, 2017, 2018, 2019],                           [20000, 40000, 60000, 80000]),
    ("Jaguar", "E-Pace", [2017, 2018, 2019, 2020],                           [10000, 20000, 40000, 60000]),

    # ── SUBARU ────────────────────────────────────────────────────────────
    ("Subaru", "Outback",  [2013, 2014, 2015, 2016, 2017, 2018],             [30000, 50000, 70000, 90000]),
    ("Subaru", "Forester", [2013, 2014, 2015, 2016, 2017, 2018],             [30000, 50000, 70000, 90000]),
    ("Subaru", "Impreza",  [2013, 2014, 2015, 2016, 2017],                   [30000, 50000, 70000, 90000]),

    # ── MITSUBISHI ────────────────────────────────────────────────────────
    ("Mitsubishi", "Outlander", [2013, 2014, 2015, 2016, 2017, 2018],        [30000, 50000, 70000, 90000]),
    ...
    ("Mitsubishi", "Eclipse",   [2017, 2018, 2019, 2020],                    [10000, 20000, 40000, 60000]),
    ...
    ("Suzuki", "Ignis",        [2016, 2017, 2018, 2019],                     [10000, 20000, 40000]),
    ("Suzuki", "Grand Vitara", [2010, 2011, 2012, 2013, 2014, 2015],         [40000, 60000, 80000, 100000, 120000]),
    ("Suzuki", "Baleno",       [2016, 2017, 2018, 2019],                     [10000, 20000, 40000, 60000]),
    ...
    ("Dacia", "Logan",   [2013, 2014, 2015, 2016, 2017],                     [30000, 50000, 70000, 90000]),
    ...
    ("Jeep", "Compass",  [2017, 2018, 2019, 2020],                           [10000, 20000, 40000, 60000]),
    ("Jeep", "Cherokee", [2014, 2015, 2016, 2017, 2018],                     [30000, 50000, 70000, 90000]),

    # ── TESLA ─────────────────────────────────────────────────────────────
    ("Tesla", "Model 3", [2019, 2020, 2021, 2022],                           [10000, 20000, 40000, 60000]),
    ...
    ("Lexus", "CT", [2013, 2014, 2015, 2016, 2017],                          [30000, 50000, 70000, 90000]),
    ("Lexus", "NX", [2015, 2016, 2017, 2018],                                [20000, 40000, 60000]),
    ("Lexus", "RX", [2013, 2014, 2015, 2016, 2017, 2018],                    [30000, 50000, 70000, 90000]),

    # ── PORSCHE ───────────────────────────────────────────────────────────
    ("Porsche", "Cayenne", [2013, 2014, 2015, 2016, 2017, 2018],             [30000, 50000, 70000, 90000]),
